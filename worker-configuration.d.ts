/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f6f206e001d9055372ce74d0b8c7651b)
// Runtime types generated with workerd@1.20260317.1 2026-03-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "WeatherSync";
	}
	interface Env {
		ASSETS: Fetcher;
		OPENWEATHER_API_KEY: string;
		WEATHER_SYNC: DurableObjectNamespace<import("./worker/index").WeatherSync>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENWEATHER_API_KEY">> {}
}
